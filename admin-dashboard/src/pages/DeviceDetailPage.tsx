...
const COMMAND_TYPES = [
  ...
  { value: 'inventory', label: 'Run Inventory', icon: FileSearch, color: 'text-blue-600' },
  ...
  if (error || !device) {
    return (
      <div className="text-center py-12">
        ...
        <button onClick={() => navigate('/devices')} className="mt-3 text-sm text-blue-600 hover:text-blue-500">
          Back to Devices
        </button>
      </div>
    );
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            ...
            <ResponsiveContainer width="100%" height={280}>
              <LineChart data={device.recent_heartbeats || []}>
                ...
                />
                <Line type="monotone" dataKey="cpu_usage" stroke="#0080ff" strokeWidth={2} dot={false} name="CPU %" />
            ...
            {COMMAND_TYPES.map((cmd) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-3 p-3 rounded-lg border text-left transition-all border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/10 disabled:opacity-50"
                >
